...
def frameLayout(root):
    ...
    Frame_right.rowconfigure((0,1,3),weight=1)
    Frame_right.rowconfigure(2,weight=15)
...
def Menu_right(Frame_right):
    ...
    l2.grid(row=2,column=0,sticky=NSEW,padx=20)
    return l1,l2
...
def infor2(l2):
    Label(l2,text="ไอดี",bg='#FBE09A').grid(row=0,column=0,sticky=N,pady=20)
    Label(l2,text="ชื่อสินค้า",bg='#FBE09A').grid(row=0,column=1,sticky=N,pady=20)
    Label(l2,text="ราคา",bg='#FBE09A').grid(row=0,column=2,sticky=N,pady=20)
    Label(l2,text="จำนวนสินค้า",bg='#FBE09A').grid(row=0,column=3,sticky=N,pady=20)
    Label(l2,text="สถานะ",bg='#FBE09A').grid(row=0,column=4,sticky=N,pady=20)
