...
def frameLayout(root):
    ...
    Button(Frame_right,text="+ เปิดใบสั่งซื้อใหม่",bg=button_color,width=15).grid(row=2,column=0,sticky=NE,padx=20)
...
def Menu_left(Frame_left):
    ...
    Button(Frame_left,image=images6,text="ออกจากระบบ  ",bg=bg_color,relief = "raised",compound=RIGHT).grid(row=7,column=1,sticky=W,pady=25)
...
def Menu_right(Frame_right):
    ...
    l2.columnconfigure((0,1,2,3,4,5,6,7),weight=1)
...
def layer_top(l1):
    ...
    Button(l1,text="รีเฟรช",image=images8,compound=RIGHT,bg=button_color,relief = "raised",width=100,height=40).grid(row=0,column=3,rowspan=2)
    

def infor2(l2):
    Label(l2,text="#",bg='#FBE09A').grid(row=0,column=0,sticky=NW,pady=20,padx=5)
    Label(l2,text="ชื่อบริษัท",bg='#FBE09A').grid(row=0,column=1,pady=20,sticky=NW)
    Label(l2,text="เลขใบสั่งซื้อ",bg='#FBE09A').grid(row=0,column=2,sticky=N,pady=20)
    Label(l2,text="เบอร์ติดต่อ",bg='#FBE09A').grid(row=0,column=3,sticky=N,pady=20)
    Label(l2,text="ยอดสั่งซื้อ",bg='#FBE09A').grid(row=0,column=4,sticky=N,pady=20)
    Label(l2,text="ราคา",bg='#FBE09A').grid(row=0,column=5,sticky=N,pady=20)
    Label(l2,text="สถานะ",bg='#FBE09A').grid(row=0,column=6,sticky=N,pady=20)
    Label(l2,text="วันที่",bg='#FBE09A').grid(row=0,column=7,sticky=N,pady=20)
